...
class Profile extends Component {
    ...
    render() {
        if (this.state.profile) {
            return (
                <Col sm={12}>
                    <h1>Profile info / <small>{this.state.profile.profile.uuid}</small></h1>
                    <div class="row">
                        <Col sm={5}>
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="profileData" action="" method="POST">
                                        <div class="form-group row">
                                            ...
                                            <input name="name" type="text" readonly class="col-sm-10 form-control-plaintext" id="profileName" value={this.state.profile.profile.name} />
                                        </div>
                                        <div class="form-group row">
                                            <label for="profileEmail" class="col-sm-2 col-form-label"><b>e-mail</b></label>
                                            <input name="email" type="text" readonly class="col-sm-10 form-control-plaintext" id="profileEmail" value={this.state.profile.profile.email} />
                                        </div>
                                        <div class="form-group row">
